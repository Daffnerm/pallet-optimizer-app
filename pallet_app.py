...
if carton_height > max_height:
    ...
    if cartons_per_layer > 0:
        # Special visualization for 17x13 cartons (FIXED POSITIONS)
        if (carton_length == 17 and carton_width == 13) or (carton_length == 13 and carton_width == 17):
            positions = [
                ...
                # Middle row
                {"x": 0, "y": 13, "w": 17, "h": 13},
                {"x": 17, "y": 13, "w": 13, "h": 17},  # vertical
                {"x": 30, "y": 13, "w": 17, "h": 13},
                
                # Top row
                {"x": 0, "y": 26, "w": 13, "h": 17},  # vertical
                {"x": 13, "y": 26, "w": 17, "h": 13},
                {"x": 30, "y": 26, "w": 13, "h": 17}   # vertical (FIXED from x=34 to x=30)
            ]
